...
def resize_icons():
    ...
    # Now that dependencies are installed, import PIL
    ...
    for icon_path in FEATURES_DIR.glob("*.png"):
        ...
        subprocess.check_call(["cp", str(icon_path), str(backup_path)])
        ...
        try:
            ...
            subprocess.check_call(["cp", str(backup_path), str(icon_path)])
