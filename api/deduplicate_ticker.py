...
Removes duplicate entries based on timestamp and article_title.

Usage:
    # Run inside docker container
    docker compose exec api python /app/deduplicate_ticker.py <ticker_symbol>
    
Example:
    docker compose exec api python /app/deduplicate_ticker.py aacr
    docker compose exec api python /app/deduplicate_ticker.py aal
"""
...
def deduplicate_ticker_file(ticker):
    ...
    Args:
        ticker (str): The ticker symbol (e.g., 'aacr', 'aal')
        
    Returns:
        dict: Statistics about the deduplication process
    """
    # Define file paths (for Docker environment)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python deduplicate_ticker.py <ticker_symbol>")
        print("Example: python deduplicate_ticker.py aacr")
        sys.exit(1)
